...
<!--***********************************************************************
	Promoción: Artículo descuento en bono o monedero
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='articulo_descuento_bono']">
	...
	<xsl:variable name="promo_name">Promoción: Artículo descuento en bono o monedero</xsl:variable>
...
//********** Promoción Invel: Articulo Descuento en Bono o Monedero *************

Promotion <xsl:value-of select="$eval"/> articulo_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	...
	for (a,k) in arts_a_bonificar do
		bolson_a = bolson.a;
		valor = valor + (${(a,bolson_a)} * descuento * &amp;(k/bolson_a));
		publicar_arts_<xsl:value-of select="$index"/> = publicar_arts_<xsl:value-of select="$index"/> + {(a, bolson_a * &amp;(k/bolson_a))};
		<xsl:value-of select="$beneficiados"/> = <xsl:value-of select="$beneficiados"/> + {(a, ${(a,bolson_a)} * descuento * &amp;(k/bolson_a))};
	od;
...
<xsl:if test="$destino='monedero'">
	...
	// -------------------------------- promo articulo_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo articulo_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
...
<xsl:if test="$view='parameters'">
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo articulo_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
<xsl:if test="$destino='bono'">
	extern publicar_bono_<xsl:value-of select="$index"/>;
</xsl:if>
<xsl:if test="$destino='monedero'">
