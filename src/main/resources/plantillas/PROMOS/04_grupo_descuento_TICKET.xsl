...
<!--***********************************************************************
	Promoción: Grupo descuento en ticket
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='grupo_descuento_tkt']">
	...
	<xsl:variable name="promo_name">Promoción: Grupo descuento en ticket</xsl:variable>
...
//********** Promoción Invel: Grupo Descuento en Ticket *************

Promotion <xsl:value-of select="$eval"/> grupo_descuento_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo grupo_descuento_ticket_<xsl:value-of select="$cod_promo"/>
...
<xsl:if test="$eans='uno'">
	...
	// -------------------------------- promo grupo_descuento_ticket_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo grupo_descuento_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	...
	for (a,k) in c * bolson do
		publicar_<xsl:value-of select="$index"/> = publicar_<xsl:value-of select="$index"/> + {(a, valor * (${(a,k)} / c_bolson))};
	od;
