...
<!--***********************************************************************
	Promoción: Departamento proveedor descuento en bono o monedero
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='depto_proveedor_descuento_bono_monedero']">
	...
	<xsl:variable name="promo_name">Promoción: Departamento proveedor descuento en bono o monedero</xsl:variable>
...
//********** Promoción Invel: Departamento proveedor descuento en bono o monedero *************

Promotion <xsl:value-of select="$eval"/> depto_proveedor_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	monto &gt; 0;
<xsl:if test="$limitar_medio='true'">
	(%(100 * monto) / 100) &lt;= (%(100 * (<xsl:for-each select="medios/m">means.m<xsl:number value="position()"/><xsl:if test="not(position()=last())"> + </xsl:if></xsl:for-each>)) / 100);
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo depto_proveedor_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
<xsl:if test="$destino='bono'">
...
<xsl:if test="$destino='monedero'">
	...
	// -------------------------------- promo depto_proveedor_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo depto_proveedor_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
