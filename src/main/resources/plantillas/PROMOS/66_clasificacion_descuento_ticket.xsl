...
<!--***********************************************************************
	Promoción: Clasificacion - Descuento en Ticket
	Autor: Fabian Ramirez
	Fecha: 23/05/2012
  **********************************************************************-->

<xsl:template match="promo[@promotype='clasificacion_descuento_ticket']">
...
Promotion <xsl:value-of select="$eval"/> clasificacion_descuento_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo clasificacion_descuento_ticket_<xsl:value-of select="$cod_promo"/>
