...
<!--***********************************************************************
	Promoción: Grupo agregar artículo en ticket
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='grupo_agregar_articulo_tkt']">
	...
	<xsl:variable name="promo_name">Promoción: Grupo agregar artículo en ticket</xsl:variable>
...
//********** Promoción Invel: Grupo agregar artículo en Ticket *************

Promotion <xsl:value-of select="$eval"/> grupo_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo grupo_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
<xsl:if test="$eans='uno'">
	...
	// -------------------------------- promo grupo_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo grupo_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
