...
<!--***********************************************************************
	Promoción: Vuelto de medio y submedio cupon en ticket o monitor
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='vuelto_msm_cupon_tkt_monitor']">
	...
	<xsl:variable name="promo_name">Promoción: Vuelto de medio y submedio cupon en ticket o monitor</xsl:variable>
...
//********** Promoción Invel: Vuelto con MSM cupon en TICKET o MONITOR *************

Promotion <xsl:value-of select="$eval"/> vuelto_msm_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo vuelto_msm_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
<xsl:for-each select="medios/m">
	...
	// -------------------------------- promo vuelto_msm_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo vuelto_msm_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
