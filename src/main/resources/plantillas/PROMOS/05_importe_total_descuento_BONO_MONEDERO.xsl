...
<!--***********************************************************************
	Promoción: Importe total descuento en bono o monedero
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='importe_total_descuento_bono_monedero']">
	...
	<xsl:variable name="promo_name">Promoción: Importe total descuento en bono o monedero</xsl:variable>
...
//********** Promoción Invel: Importe Total Descuento en Bono o Monedero *************

Promotion <xsl:value-of select="$eval"/> importe_total_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo importe_total_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
...
<xsl:if test="$destino='monedero'">
	...
	// -------------------------------- promo importe_total_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo importe_total_descuento_bono_monedero_<xsl:value-of select="$cod_promo"/>
