...
<xsl:template match="promo[@promotype='m_x_n_articulos_distintos_multiple_tkt']">
...
Promotion <xsl:value-of select="$eval"/> m_x_n_articulos_distintos_multiple_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo m_x_n_articulos_distintos_multiple_ticket_<xsl:value-of select="$cod_promo"/>
<xsl:if test="$eans='uno'">
	...
	// -------------------------------- promo m_x_n_articulos_distintos_multiple_ticket_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo m_x_n_articulos_distintos_multiple_ticket_<xsl:value-of select="$cod_promo"/>
