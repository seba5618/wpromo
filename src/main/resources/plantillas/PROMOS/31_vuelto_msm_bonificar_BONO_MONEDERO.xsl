...
<!--***********************************************************************
	Promoción: Vuelto de medio y submedio bonificar en bono
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='vuelto_msm_bonificar_bono_monedero']">
	...
	<xsl:variable name="promo_name">Promoción: Vuelto de medio y submedio bonificar en bono</xsl:variable>
...
//********** Promoción Invel: Vuelto con MSM bonificar en BONO o Monedero *************

Promotion <xsl:value-of select="$eval"/> vuelto_msm_bonificar_bono_monedero_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	monedero = card(i3,null);
	descuento = <xsl:value-of select="$descuento"/>;

	monto = (<xsl:for-each select="medios/m/medio">change.<xsl:if test="@datatype = 'mutual'">mutual m<xsl:value-of select="."/>s<xsl:value-of select="../plan"/></xsl:if><xsl:if test="@datatype = 'idcard'">card(<xsl:if test=". = 0">null</xsl:if><xsl:if test=". &gt; 0">i<xsl:apply-templates select="."/></xsl:if>,<xsl:if test="../plan = 0">null</xsl:if><xsl:if test="../plan &gt; 0">p<xsl:apply-templates select="../plan"/></xsl:if>)</xsl:if><xsl:if test="@datatype = 'ticket'">ticket m<xsl:value-of select="."/>s<xsl:value-of select="../plan"/></xsl:if><xsl:if test="@datatype = 'cash'"><xsl:apply-templates select="."/></xsl:if><xsl:if test="@datatype = 'ctacte'"><xsl:apply-templates select="."/></xsl:if><xsl:if test="@datatype = 'cheque'"><xsl:apply-templates select="."/></xsl:if><xsl:if test="not(position()=last())"> + </xsl:if></xsl:for-each>);
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo vuelto_msm_bonificar_bono_monedero_<xsl:value-of select="$cod_promo"/>
<xsl:if test="$destino='bono'">
...
<xsl:if test="$destino='monedero'">
	...
	// -------------------------------- promo vuelto_msm_bonificar_bono_monedero_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo vuelto_msm_bonificar_bono_monedero_<xsl:value-of select="$cod_promo"/>
...
<xsl:for-each select="medios/m/medio">
	if (change.<xsl:if test="@datatype = 'mutual'">mutual m<xsl:value-of select="."/>s<xsl:value-of select="../plan"/></xsl:if><xsl:if test="@datatype = 'idcard'">card(<xsl:if test=". = 0">null</xsl:if><xsl:if test=". &gt; 0">i<xsl:apply-templates select="."/></xsl:if>,<xsl:if test="../plan = 0">null</xsl:if><xsl:if test="../plan &gt; 0">p<xsl:apply-templates select="../plan"/></xsl:if>)</xsl:if><xsl:if test="@datatype = 'ticket'">ticket m<xsl:value-of select="."/>s<xsl:value-of select="../plan"/></xsl:if><xsl:if test="@datatype = 'cash'"><xsl:apply-templates select="."/></xsl:if><xsl:if test="@datatype = 'ctacte'"><xsl:apply-templates select="."/></xsl:if><xsl:if test="@datatype = 'cheque'"><xsl:apply-templates select="."/></xsl:if> &gt; 0)then
