...
<xsl:template match="promo[@promotype='bambu_varios_medios_descuento_ticket']">
...
<!-- <<<<<<<<<<<<<< -->
	...
	// -------------------------------- promo bambu_varios_medios_descuento_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo bambu_varios_medios_descuento_ticket_<xsl:value-of select="$cod_promo"/>
