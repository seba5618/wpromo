...
<!--***********************************************************************
	Promoción: Artículo cupón en ticket o monitor
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='articulo_cupon_tkt_monitor']">
	...
	<xsl:variable name="promo_name">Promoción: Artículo cupón en ticket o monitor</xsl:variable>
...
//********** Promoción Invel: Artículo Cupón en Ticket o Monitor *************

Promotion <xsl:value-of select="$eval"/> articulo_cupon_tkt_monitor_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo articulo_cupon_tkt_monitor_<xsl:value-of select="$cod_promo"/>
	...
	// -------------------------------- promo articulo_cupon_tkt_monitor_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo articulo_cupon_tkt_monitor_<xsl:value-of select="$cod_promo"/>
...
<xsl:if test="$por_cada!='0'">
	valor = &amp;($copia / por_cada) * descuento_fijo;
</xsl:if>
