...
<!--***********************************************************************
	Promoción: Grupo Parcial precio fijo en ticket
	Autor: Marcelo Mancuso
	Fecha: 15/10/2015
  **********************************************************************-->

<xsl:template match="promo[@promotype='grupo_parcial_precio_fijo_ticket']">
...
Promotion <xsl:value-of select="$eval"/> grupo_parcial_precio_fijo_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo grupo_parcial_precio_fijo_ticket_<xsl:value-of select="$cod_promo"/>
...
<xsl:if test="$eans='uno'">
	...
	// -------------------------------- promo grupo_parcial_precio_fijo_ticket_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la grupo_parcial_precio_fijo_ticket_<xsl:value-of select="$cod_promo"/>
