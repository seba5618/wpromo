...
<!--***********************************************************************
	Promoción: Grupo cupón en ticket o monitor
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='grupo_cupon_tkt_monitor']">
	...
	<xsl:variable name="promo_name">Promoción: Grupo cupón en ticket o monitor</xsl:variable>
...
//********** Promoción Invel: Grupo Cupón en Ticket o Monitor *************

Promotion <xsl:value-of select="$eval"/> grupo_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo grupo_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
	...
	// -------------------------------- promo grupo_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo grupo_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
