...
<!--***********************************************************************
	Promoción: Pago con medio y submedio cupón en bono
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='pago_msm_cupon_bono']">
	...
	<xsl:variable name="promo_name">Promoción: Pago con medio y submedio cupón en bono</xsl:variable>
...
//********** Promoción Invel: Pago Medio SubMedio cupón en BONO *************

Promotion <xsl:value-of select="$eval"/> pago_msm_cupon_bono_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo pago_msm_cupon_bono_<xsl:value-of select="$cod_promo"/>
<xsl:for-each select="medios/m">
	...
	// -------------------------------- promo pago_msm_cupon_bono_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo pago_msm_cupon_bono_<xsl:value-of select="$cod_promo"/>
