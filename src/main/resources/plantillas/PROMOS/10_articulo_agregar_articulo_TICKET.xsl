...
<!--***********************************************************************
	Promoción: Artículo agregar artículo en ticket
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='articulo_agregar_articulo_tkt']">
	...
	<xsl:variable name="promo_name">Promoción: Artículo agregar artículo en ticket</xsl:variable>
...
//********** Promoción Invel: Artículo agregar artículo en Ticket *************

Promotion <xsl:value-of select="$eval"/> articulo_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	...
	publicar_<xsl:value-of select="$index"/> = publicar_<xsl:value-of select="$index"/> + {(articulo, c * ${(articulo,1)} * descuento)};
	publicar_arts_<xsl:value-of select="$index"/> = {(articulo, c)};
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo articulo_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
<xsl:if test="$eans='uno'">
	...
	// -------------------------------- promo articulo_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo articulo_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
