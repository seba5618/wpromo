...
<!--***********************************************************************
	Promoción: Importe total cupón en ticket o monitor
	Autor: Elio Mauro Carreras
	Fecha: 12/03/2007
  **********************************************************************-->

<xsl:template match="promo[@promotype='importe_total_cupon_tkt_monitor']">
	...
	<xsl:variable name="promo_name">Promoción: Importe total cupón en ticket o monitor</xsl:variable>
...
//********** Promoción Invel: Importe Total Cupón en Ticket o Monitor *************

Promotion <xsl:value-of select="$eval"/> importe_total_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo importe_total_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
	...
	// -------------------------------- promo importe_total_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo importe_total_cupon_ticket_monitor_<xsl:value-of select="$cod_promo"/>
