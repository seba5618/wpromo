...
<xsl:template match="promo[@promotype='grupo_parcial_agregar_articulo_ticket']">
...
Promotion <xsl:value-of select="$eval"/> grupo_parcial_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
...
<!-- <<<<<<<<<<<<<< -->
	...
	for (a,k) in entregar do
		cantidad = (c * k) min entregando.a;
		if (cantidad &gt; 0)then
...
<!-- <<<<<<<<<<<<<< -->
	// Parametros correspondientes a la promo grupo_parcial_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
	extern publicar_<xsl:value-of select="$index"/>;
	extern publicar_arts_<xsl:value-of select="$index"/>;
	// -------------------------------- promo grupo_parcial_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
<!-- >>>>>>>>>>>>>> -->
</xsl:if>
...
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la promo grupo_parcial_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
...
<xsl:if test="$view='benefits'">
<!-- <<<<<<<<<<<<<< -->
	// Aplicando Beneficios correspondientes a la grupo_parcial_agregar_articulo_ticket_<xsl:value-of select="$cod_promo"/>
